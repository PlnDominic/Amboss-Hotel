            ...
            <div className="flex flex-col gap-3.5 text-xs text-white/70">
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col gap-0.5">
                  <span>Santasi Apire, Kumasi, Ghana</span>
                  <span>Postal Address: SN 284, Santasi</span>
                  <span className="font-bold text-brand-accent">Ghana Post GPS: AG-0666-2011</span>
                </div>
              </div>
              <div className="flex items-center gap-2.5">
                ...
                <span>0244 066999 · 0201 185123</span>
              </div>
              <div className="flex items-center gap-2.5">
